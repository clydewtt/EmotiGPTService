...
def gpt_integration(user_request, emotion_response, sentiment_response, conversation_history):
    ...
    system_message = {
        "role": "system",
        "content": f"""You are a normal chatbot that takes sentiment analysis as input which is {sentiment_response}.
        You will also respond with the user's actual physical emotion in mind, which is {emotion_response}."""
    }
